        ...
        <div class="grid grid-cols-3 h-80">
            ...
            <div class="col-span-2 ml-20 py-5">
                <div>
                    ...
                    <p class="text-lg mb-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, nemo animi?
                        Nostrum
                        error
                        molestias quasi
                        iste numquam ab, magnam veniam culpa odit non, vero hic, recusandae harum suscipit fugiat
                        reprehenderit?
                    </p>
                </div>
