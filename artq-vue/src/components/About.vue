<template>
  <div class="py-20 px-10 min-h-screen flex items-center justify-center">
    <div class="grid container grid-cols-3 h-80">
      <div class="h-full">
      ...
      <div class="col-span-2 ml-20 py-5">
        <div>
          ...
          <p class="text-lg mb-2">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, nemo animi? Nostrum error molestias quasi iste numquam ab, magnam veniam culpa odit non, vero hic, recusandae harum suscipit fugiat reprehenderit?
          </p>
        </div>
        <div class="w-64 flex justify-between">
          <button class="bg-gradient-to-r from-gold-400 p-2 rounded-full"><a class="text-lg font-semibold capitalize" href="">our youtube</a></button>
          <button class="bg-gradient-to-r from-gold-400 p-2 rounded-full"><a class="text-lg font-semibold capitalize" href="">our youtube</a></button>
        </div>
        <div class="flex mt-8">
          <div class="h-28 mx-5">
